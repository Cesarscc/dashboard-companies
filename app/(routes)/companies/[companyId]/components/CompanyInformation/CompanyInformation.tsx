...
export function CompanyInformation(props: CompanyInformationProps) {
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-x-10 gap-4">
            <div className="rounded-xl bg-background shadow-md hover:shadow-lg p-4">
                <div>
                    <Image src={company.profileImage}
                        alt="Company Image"
                        width={50}
                        height={50}
